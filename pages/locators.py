...
class Course413PageLocators:
    START_COURSE_BUTTON = (By.CSS_SELECTOR, 'button.ll-leokit__learn-course-lessons__module-card-button-green')
    ...
    BACK_TO_START_COURSE_BUTTON = (By.CSS_SELECTOR, 'div.ll-leokit__learn-course-lesson__button-top-back')
    TRY_COURSE_BUTTON = (
        By.CSS_SELECTOR,
